...
const FormatPresetSchema = z.object({
  ...
  modelId: z.enum(["gpt-5-nano", "gpt-5-mini", "gpt-5", "gpt-4.1-nano", "gpt-4o-mini", "gpt-4.1-mini", "gpt-4.1", "gpt-4o"]),
...
const UpdateFormatPresetSchema = z.object({
  ...
  modelId: z.enum(["gpt-5-nano", "gpt-5-mini", "gpt-5", "gpt-4.1-nano", "gpt-4o-mini", "gpt-4.1-mini", "gpt-4.1", "gpt-4o"]).optional(),
