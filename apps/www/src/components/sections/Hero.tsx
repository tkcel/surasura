  ...
  return (
    <section className="relative pt-40 pb-32 md:pt-52 md:pb-44 min-h-screen flex items-center bg-gray-50 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white text-primary-700 rounded-full text-sm font-medium mb-8 shadow-sm border border-primary-100">
          基本使用料無料・月額課金なし
        </div>
