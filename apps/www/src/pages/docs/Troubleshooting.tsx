  ...
  return (
    <>
      ...
      <DocsOrderedList>
        ...
        <DocsListItem>「詳細設定」タブを選択</DocsListItem>
        <DocsListItem>「プリセットをリセット」をクリック</DocsListItem>
        <DocsListItem>確認ダイアログで「リセット」を選択</DocsListItem>
      </DocsOrderedList>

      <DocsNote>
        リセットすると、カスタムで作成したプリセットは削除されます。必要に応じてバックアップを取っておいてください。
      </DocsNote>

      <DocsH3>デフォルトプリセット一覧</DocsH3>
...
- 辞書に登録された専門用語・固有名詞は正確に使用する`}</CodeBlock>
      </DocsDetails>
